...
/**
 * This is the item provider adapter for a {@link net.sf.smbt.mdl.arduino.Port} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class PortItemProvider
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Port_map_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Port_map_feature", "_UI_Port_type"),
				 ArduinoPackage.Literals.PORT__MAP,
				 true,
				 false,
				 false,
	...
	protected void addReportPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Port_report_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Port_report_feature", "_UI_Port_type"),
				 ArduinoPackage.Literals.PORT__REPORT,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	protected void addChannelPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Port_channel_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Port_channel_feature", "_UI_Port_type"),
				 ArduinoPackage.Literals.PORT__CHANNEL,
				 true,
				 false,
				 false,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 ArduinoPackage.Literals.PORT__NAME,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(Port.class)) {
			case ArduinoPackage.PORT__MAP:
			case ArduinoPackage.PORT__REPORT:
			case ArduinoPackage.PORT__CHANNEL:
			case ArduinoPackage.PORT__NAME:

 ...
 * 
 */
public class ArduinoPropertiesEditionPartImpl extends CompositePropertiesEditionPart implements ISWTPropertiesEditionPart, ArduinoPropertiesEditionPart {
	 ...
	 * 
	 */
	public ArduinoPropertiesEditionPartImpl(IPropertiesEditionComponent editionComponent) {
	...
	protected Composite createPropertiesGroup(Composite parent) {
		...
		propertiesGroup.setText(ArduinoMessages.ArduinoPropertiesEditionPart_PropertiesGroupLabel);
	...
	protected Composite createVerEMFComboViewer(Composite parent) {
		...
		ver.addSelectionChangedListener(new ISelectionChangedListener() {
			...
			public void selectionChanged(SelectionChangedEvent event) {
				if (propertiesEditionComponent != null)
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(ArduinoPropertiesEditionPartImpl.this, ArduinoViewsRepository.Arduino_.Properties.ver, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, getVer()));
			}

		});
		ver.setID(ArduinoViewsRepository.Arduino_.Properties.ver);
		SWTUtils.createHelpButton(parent, propertiesEditionComponent.getHelpContent(ArduinoViewsRepository.Arduino_.Properties.ver, ArduinoViewsRepository.SWT_KIND), null); //$NON-NLS-1$
	...
	protected Composite createBoardEMFComboViewer(Composite parent) {
		...
		board.addSelectionChangedListener(new ISelectionChangedListener() {
			...
			public void selectionChanged(SelectionChangedEvent event) {
				if (propertiesEditionComponent != null)
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(ArduinoPropertiesEditionPartImpl.this, ArduinoViewsRepository.Arduino_.Properties.board, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, getBoard()));
			}

		});
		board.setID(ArduinoViewsRepository.Arduino_.Properties.board);
		SWTUtils.createHelpButton(parent, propertiesEditionComponent.getHelpContent(ArduinoViewsRepository.Arduino_.Properties.board, ArduinoViewsRepository.SWT_KIND), null); //$NON-NLS-1$
	...
	protected Composite createSeriesEMFComboViewer(Composite parent) {
		...
		series.addSelectionChangedListener(new ISelectionChangedListener() {
			...
			public void selectionChanged(SelectionChangedEvent event) {
				if (propertiesEditionComponent != null)
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(ArduinoPropertiesEditionPartImpl.this, ArduinoViewsRepository.Arduino_.Properties.series, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, getSeries()));
			}

		});
		series.setID(ArduinoViewsRepository.Arduino_.Properties.series);
		SWTUtils.createHelpButton(parent, propertiesEditionComponent.getHelpContent(ArduinoViewsRepository.Arduino_.Properties.series, ArduinoViewsRepository.SWT_KIND), null); //$NON-NLS-1$
	 ...
	 * 
	 */
	protected Composite createDigitalPortsAdvancedTableComposition(Composite parent) {
		this.digitalPorts = new ReferencesTable(getDescription(ArduinoViewsRepository.Arduino_.Properties.digitalPorts, ArduinoMessages.ArduinoPropertiesEditionPart_DigitalPortsLabel), new ReferencesTableListener() {
			public void handleAdd() { 
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(ArduinoPropertiesEditionPartImpl.this, ArduinoViewsRepository.Arduino_.Properties.digitalPorts, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.ADD, null, null));
				digitalPorts.refresh();
			}
			public void handleEdit(EObject element) {
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(ArduinoPropertiesEditionPartImpl.this, ArduinoViewsRepository.Arduino_.Properties.digitalPorts, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.EDIT, null, element));
				digitalPorts.refresh();
			}
			public void handleMove(EObject element, int oldIndex, int newIndex) { 
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(ArduinoPropertiesEditionPartImpl.this, ArduinoViewsRepository.Arduino_.Properties.digitalPorts, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.MOVE, element, newIndex));
				digitalPorts.refresh();
			}
			public void handleRemove(EObject element) { 
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(ArduinoPropertiesEditionPartImpl.this, ArduinoViewsRepository.Arduino_.Properties.digitalPorts, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.REMOVE, null, element));
				digitalPorts.refresh();
			}
		...
		this.digitalPorts.setHelpText(propertiesEditionComponent.getHelpContent(ArduinoViewsRepository.Arduino_.Properties.digitalPorts, ArduinoViewsRepository.SWT_KIND));
		this.digitalPorts.createControls(parent);
		this.digitalPorts.addSelectionListener(new SelectionAdapter() {
			
			public void widgetSelected(SelectionEvent e) {
				if (e.item != null && e.item.getData() instanceof EObject) {
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(ArduinoPropertiesEditionPartImpl.this, ArduinoViewsRepository.Arduino_.Properties.digitalPorts, PropertiesEditionEvent.CHANGE, PropertiesEditionEvent.SELECTION_CHANGED, null, e.item.getData()));
				}
			}
		...
		// Start of user code for createDigitalPortsAdvancedTableComposition
	 ...
	 * 
	 */
	protected Composite createAnalogPortsAdvancedTableComposition(Composite parent) {
		this.analogPorts = new ReferencesTable(getDescription(ArduinoViewsRepository.Arduino_.Properties.analogPorts, ArduinoMessages.ArduinoPropertiesEditionPart_AnalogPortsLabel), new ReferencesTableListener() {
			public void handleAdd() { 
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(ArduinoPropertiesEditionPartImpl.this, ArduinoViewsRepository.Arduino_.Properties.analogPorts, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.ADD, null, null));
				analogPorts.refresh();
			}
			public void handleEdit(EObject element) {
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(ArduinoPropertiesEditionPartImpl.this, ArduinoViewsRepository.Arduino_.Properties.analogPorts, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.EDIT, null, element));
				analogPorts.refresh();
			}
			public void handleMove(EObject element, int oldIndex, int newIndex) { 
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(ArduinoPropertiesEditionPartImpl.this, ArduinoViewsRepository.Arduino_.Properties.analogPorts, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.MOVE, element, newIndex));
				analogPorts.refresh();
			}
			public void handleRemove(EObject element) { 
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(ArduinoPropertiesEditionPartImpl.this, ArduinoViewsRepository.Arduino_.Properties.analogPorts, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.REMOVE, null, element));
				analogPorts.refresh();
			}
			public void navigateTo(EObject element) { }
		});
		...
		this.analogPorts.setHelpText(propertiesEditionComponent.getHelpContent(ArduinoViewsRepository.Arduino_.Properties.analogPorts, ArduinoViewsRepository.SWT_KIND));
		this.analogPorts.createControls(parent);
		this.analogPorts.addSelectionListener(new SelectionAdapter() {
			
			public void widgetSelected(SelectionEvent e) {
				if (e.item != null && e.item.getData() instanceof EObject) {
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(ArduinoPropertiesEditionPartImpl.this, ArduinoViewsRepository.Arduino_.Properties.analogPorts, PropertiesEditionEvent.CHANGE, PropertiesEditionEvent.SELECTION_CHANGED, null, e.item.getData()));
				}
			}
		...
		// Start of user code for createAnalogPortsAdvancedTableComposition
	 ...
	 * 
	 */
	protected Composite createGroundPortsAdvancedTableComposition(Composite parent) {
		this.groundPorts = new ReferencesTable(getDescription(ArduinoViewsRepository.Arduino_.Properties.groundPorts, ArduinoMessages.ArduinoPropertiesEditionPart_GroundPortsLabel), new ReferencesTableListener() {
			public void handleAdd() { 
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(ArduinoPropertiesEditionPartImpl.this, ArduinoViewsRepository.Arduino_.Properties.groundPorts, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.ADD, null, null));
				groundPorts.refresh();
			}
			public void handleEdit(EObject element) {
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(ArduinoPropertiesEditionPartImpl.this, ArduinoViewsRepository.Arduino_.Properties.groundPorts, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.EDIT, null, element));
				groundPorts.refresh();
			}
			public void handleMove(EObject element, int oldIndex, int newIndex) { 
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(ArduinoPropertiesEditionPartImpl.this, ArduinoViewsRepository.Arduino_.Properties.groundPorts, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.MOVE, element, newIndex));
				groundPorts.refresh();
			}
			public void handleRemove(EObject element) { 
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(ArduinoPropertiesEditionPartImpl.this, ArduinoViewsRepository.Arduino_.Properties.groundPorts, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.REMOVE, null, element));
				groundPorts.refresh();
			}
			public void navigateTo(EObject element) { }
		});
		...
		this.groundPorts.setHelpText(propertiesEditionComponent.getHelpContent(ArduinoViewsRepository.Arduino_.Properties.groundPorts, ArduinoViewsRepository.SWT_KIND));
		this.groundPorts.createControls(parent);
		this.groundPorts.addSelectionListener(new SelectionAdapter() {
			
			public void widgetSelected(SelectionEvent e) {
				if (e.item != null && e.item.getData() instanceof EObject) {
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(ArduinoPropertiesEditionPartImpl.this, ArduinoViewsRepository.Arduino_.Properties.groundPorts, PropertiesEditionEvent.CHANGE, PropertiesEditionEvent.SELECTION_CHANGED, null, e.item.getData()));
				}
			}
		...
		// Start of user code for createGroundPortsAdvancedTableComposition
	...
	protected Composite createLabelText(Composite parent) {
		...
		label.addFocusListener(new FocusAdapter() {
			...
			public void focusLost(FocusEvent e) {
				if (propertiesEditionComponent != null)
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(ArduinoPropertiesEditionPartImpl.this, ArduinoViewsRepository.Arduino_.Properties.label, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, label.getText()));
			}
		...
		SWTUtils.createHelpButton(parent, propertiesEditionComponent.getHelpContent(ArduinoViewsRepository.Arduino_.Properties.label, ArduinoViewsRepository.SWT_KIND), null); //$NON-NLS-1$
	...
	protected Composite createCommEMFComboViewer(Composite parent) {
		...
		comm.addSelectionChangedListener(new ISelectionChangedListener() {
			...
			public void selectionChanged(SelectionChangedEvent event) {
				if (propertiesEditionComponent != null)
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(ArduinoPropertiesEditionPartImpl.this, ArduinoViewsRepository.Arduino_.Properties.comm, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, getComm()));
			}

		});
		comm.setID(ArduinoViewsRepository.Arduino_.Properties.comm);
		SWTUtils.createHelpButton(parent, propertiesEditionComponent.getHelpContent(ArduinoViewsRepository.Arduino_.Properties.comm, ArduinoViewsRepository.SWT_KIND), null); //$NON-NLS-1$
	...
	protected Composite createFirmataModeEMFComboViewer(Composite parent) {
		...
		firmataMode.addSelectionChangedListener(new ISelectionChangedListener() {
			...
			public void selectionChanged(SelectionChangedEvent event) {
				if (propertiesEditionComponent != null)
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(ArduinoPropertiesEditionPartImpl.this, ArduinoViewsRepository.Arduino_.Properties.firmataMode, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, getFirmataMode()));
			}

		});
		firmataMode.setID(ArduinoViewsRepository.Arduino_.Properties.firmataMode);
		SWTUtils.createHelpButton(parent, propertiesEditionComponent.getHelpContent(ArduinoViewsRepository.Arduino_.Properties.firmataMode, ArduinoViewsRepository.SWT_KIND), null); //$NON-NLS-1$
	...
	protected Composite createLockedPinEMFComboViewer(Composite parent) {
		...
		lockedPin.addSelectionChangedListener(new ISelectionChangedListener() {
			...
			public void selectionChanged(SelectionChangedEvent event) {
				if (propertiesEditionComponent != null)
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(ArduinoPropertiesEditionPartImpl.this, ArduinoViewsRepository.Arduino_.Properties.lockedPin, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, getLockedPin()));
			}

		});
		lockedPin.setID(ArduinoViewsRepository.Arduino_.Properties.lockedPin);
		SWTUtils.createHelpButton(parent, propertiesEditionComponent.getHelpContent(ArduinoViewsRepository.Arduino_.Properties.lockedPin, ArduinoViewsRepository.SWT_KIND), null); //$NON-NLS-1$
	...
	protected Composite createSynchronizingCheckbox(Composite parent) {
		synchronizing = new Button(parent, SWT.CHECK);
		synchronizing.setText(getDescription(ArduinoViewsRepository.Arduino_.Properties.synchronizing, ArduinoMessages.ArduinoPropertiesEditionPart_SynchronizingLabel));
		synchronizing.addSelectionListener(new SelectionAdapter() {
			...
			public void widgetSelected(SelectionEvent e) {
				if (propertiesEditionComponent != null)
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(ArduinoPropertiesEditionPartImpl.this, ArduinoViewsRepository.Arduino_.Properties.synchronizing, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, new Boolean(synchronizing.getSelection())));
			}
		...
		SWTUtils.createHelpButton(parent, propertiesEditionComponent.getHelpContent(ArduinoViewsRepository.Arduino_.Properties.synchronizing, ArduinoViewsRepository.SWT_KIND), null); //$NON-NLS-1$
	...
	protected Composite createStatusEMFComboViewer(Composite parent) {
		...
		status.addSelectionChangedListener(new ISelectionChangedListener() {
			...
			public void selectionChanged(SelectionChangedEvent event) {
				if (propertiesEditionComponent != null)
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(ArduinoPropertiesEditionPartImpl.this, ArduinoViewsRepository.Arduino_.Properties.status, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, getStatus()));
			}

		});
		status.setID(ArduinoViewsRepository.Arduino_.Properties.status);
		SWTUtils.createHelpButton(parent, propertiesEditionComponent.getHelpContent(ArduinoViewsRepository.Arduino_.Properties.status, ArduinoViewsRepository.SWT_KIND), null); //$NON-NLS-1$
	...
	protected Composite createKindEMFComboViewer(Composite parent) {
		...
		kind.addSelectionChangedListener(new ISelectionChangedListener() {
			...
			public void selectionChanged(SelectionChangedEvent event) {
				if (propertiesEditionComponent != null)
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(ArduinoPropertiesEditionPartImpl.this, ArduinoViewsRepository.Arduino_.Properties.kind, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, getKind()));
			}

		});
		kind.setID(ArduinoViewsRepository.Arduino_.Properties.kind);
		SWTUtils.createHelpButton(parent, propertiesEditionComponent.getHelpContent(ArduinoViewsRepository.Arduino_.Properties.kind, ArduinoViewsRepository.SWT_KIND), null); //$NON-NLS-1$
	...
	protected Composite createNameText(Composite parent) {
		...
		name.addFocusListener(new FocusAdapter() {
			...
			public void focusLost(FocusEvent e) {
				if (propertiesEditionComponent != null)
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(ArduinoPropertiesEditionPartImpl.this, ArduinoViewsRepository.Arduino_.Properties.name, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, name.getText()));
			}
		...
		SWTUtils.createHelpButton(parent, propertiesEditionComponent.getHelpContent(ArduinoViewsRepository.Arduino_.Properties.name, ArduinoViewsRepository.SWT_KIND), null); //$NON-NLS-1$

 ...
 * 
 */
public class RxPortPropertiesEditionPartForm extends SectionPropertiesEditingPart implements IFormPropertiesEditionPart, RxPortPropertiesEditionPart {
	 ...
	 */
	public RxPortPropertiesEditionPartForm() { super(); }
	 ...
	 * 
	 */
	public RxPortPropertiesEditionPartForm(IPropertiesEditionComponent editionComponent) {
	...
	protected Composite createPropertiesGroup(FormToolkit widgetFactory, final Composite parent) {
		...
		propertiesSection.setText(ArduinoMessages.RxPortPropertiesEditionPart_PropertiesGroupLabel);
		...
		map.addSelectionChangedListener(new ISelectionChangedListener() {
			...
			public void selectionChanged(SelectionChangedEvent event) {
				if (propertiesEditionComponent != null)
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(RxPortPropertiesEditionPartForm.this, ArduinoViewsRepository.RxPort.Properties.map, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, getMap()));
			}

		});
		map.setID(ArduinoViewsRepository.RxPort.Properties.map);
		FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent.getHelpContent(ArduinoViewsRepository.RxPort.Properties.map, ArduinoViewsRepository.FORM_KIND), null); //$NON-NLS-1$
	...
	protected Composite createReportEMFComboViewer(FormToolkit widgetFactory, Composite parent) {
		...
		report.addSelectionChangedListener(new ISelectionChangedListener() {
			...
			public void selectionChanged(SelectionChangedEvent event) {
				if (propertiesEditionComponent != null)
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(RxPortPropertiesEditionPartForm.this, ArduinoViewsRepository.RxPort.Properties.report, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, getReport()));
			}

		});
		report.setID(ArduinoViewsRepository.RxPort.Properties.report);
		FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent.getHelpContent(ArduinoViewsRepository.RxPort.Properties.report, ArduinoViewsRepository.FORM_KIND), null); //$NON-NLS-1$
	...
	protected Composite createChannelText(FormToolkit widgetFactory, Composite parent) {
			...
			public void focusLost(FocusEvent e) {
				if (propertiesEditionComponent != null) {
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
							RxPortPropertiesEditionPartForm.this,
							ArduinoViewsRepository.RxPort.Properties.channel,
		...
		channel.addKeyListener(new KeyAdapter() {
			...
			public void keyPressed(KeyEvent e) {
				if (e.character == SWT.CR) {
					if (propertiesEditionComponent != null)
						propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(RxPortPropertiesEditionPartForm.this, ArduinoViewsRepository.RxPort.Properties.channel, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, channel.getText()));
				}
			}
		});
		...
		FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent.getHelpContent(ArduinoViewsRepository.RxPort.Properties.channel, ArduinoViewsRepository.FORM_KIND), null); //$NON-NLS-1$
	...
	protected Composite createNameText(FormToolkit widgetFactory, Composite parent) {
		...
		name.addFocusListener(new FocusAdapter() {
			...
			public void focusLost(FocusEvent e) {
				if (propertiesEditionComponent != null) {
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
							RxPortPropertiesEditionPartForm.this,
							ArduinoViewsRepository.RxPort.Properties.name,
		...
		name.addKeyListener(new KeyAdapter() {
			...
			public void keyPressed(KeyEvent e) {
				if (e.character == SWT.CR) {
					if (propertiesEditionComponent != null)
						propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(RxPortPropertiesEditionPartForm.this, ArduinoViewsRepository.RxPort.Properties.name, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, name.getText()));
				}
			}
		});
		EditingUtils.setID(name, ArduinoViewsRepository.RxPort.Properties.name);
		EditingUtils.setEEFtype(name, "eef::Text"); //$NON-NLS-1$
		FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent.getHelpContent(ArduinoViewsRepository.RxPort.Properties.name, ArduinoViewsRepository.FORM_KIND), null); //$NON-NLS-1$

 ...
 * 
 */
public class TxPortPropertiesEditionPartImpl extends CompositePropertiesEditionPart implements ISWTPropertiesEditionPart, TxPortPropertiesEditionPart {
	 ...
	 * 
	 */
	public TxPortPropertiesEditionPartImpl(IPropertiesEditionComponent editionComponent) {
	...
	protected Composite createPropertiesGroup(Composite parent) {
		...
		propertiesGroup.setText(ArduinoMessages.TxPortPropertiesEditionPart_PropertiesGroupLabel);
		...
		map.addSelectionChangedListener(new ISelectionChangedListener() {
			...
			public void selectionChanged(SelectionChangedEvent event) {
				if (propertiesEditionComponent != null)
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(TxPortPropertiesEditionPartImpl.this, ArduinoViewsRepository.TxPort.Properties.map, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, getMap()));
			}

		});
		map.setID(ArduinoViewsRepository.TxPort.Properties.map);
		SWTUtils.createHelpButton(parent, propertiesEditionComponent.getHelpContent(ArduinoViewsRepository.TxPort.Properties.map, ArduinoViewsRepository.SWT_KIND), null); //$NON-NLS-1$
	...
	protected Composite createReportEMFComboViewer(Composite parent) {
		...
		report.addSelectionChangedListener(new ISelectionChangedListener() {
			...
			public void selectionChanged(SelectionChangedEvent event) {
				if (propertiesEditionComponent != null)
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(TxPortPropertiesEditionPartImpl.this, ArduinoViewsRepository.TxPort.Properties.report, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, getReport()));
			}

		});
		report.setID(ArduinoViewsRepository.TxPort.Properties.report);
		SWTUtils.createHelpButton(parent, propertiesEditionComponent.getHelpContent(ArduinoViewsRepository.TxPort.Properties.report, ArduinoViewsRepository.SWT_KIND), null); //$NON-NLS-1$
	...
	protected Composite createChannelText(Composite parent) {
		...
		channel.addFocusListener(new FocusAdapter() {
			...
			public void focusLost(FocusEvent e) {
				if (propertiesEditionComponent != null)
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(TxPortPropertiesEditionPartImpl.this, ArduinoViewsRepository.TxPort.Properties.channel, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, channel.getText()));
			}
		...
		SWTUtils.createHelpButton(parent, propertiesEditionComponent.getHelpContent(ArduinoViewsRepository.TxPort.Properties.channel, ArduinoViewsRepository.SWT_KIND), null); //$NON-NLS-1$
	...
	protected Composite createNameText(Composite parent) {
		...
		name.addFocusListener(new FocusAdapter() {
			...
			public void focusLost(FocusEvent e) {
				if (propertiesEditionComponent != null)
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(TxPortPropertiesEditionPartImpl.this, ArduinoViewsRepository.TxPort.Properties.name, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, name.getText()));
			}
		...
		SWTUtils.createHelpButton(parent, propertiesEditionComponent.getHelpContent(ArduinoViewsRepository.TxPort.Properties.name, ArduinoViewsRepository.SWT_KIND), null); //$NON-NLS-1$
